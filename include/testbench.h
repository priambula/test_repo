...
/// Тип для значения
typedef TPipeValueType TValue;
const auto currTypeID = TTraitID::fourth;
class TB_IConsumer;
...
using TKey = typename TMultiPipeProcessor<TValue,currTypeID >::TKey;
using TThreadArgs = TPipeTrait<TValue,TESTBENCH::currTypeID>::TThreadArgs;
...
extern TMultiPipeProcessor<TValue,currTypeID > * tb_pmpp;
